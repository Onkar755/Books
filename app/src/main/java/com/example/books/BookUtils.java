    ...
    private static List<Book> extractBookFromJson(String bookJSON) {
        ...
        try {
            ...
            for (int i = 0; i < booksArray.length(); i++) {
                ...
                String string = imageLinks.getString("thumbnail");
                StringBuilder imageURL = new StringBuilder(string);
                imageURL.replace(0, 4, "https");

                // Extract the value for the key called "buyLink"
                String link = (String) saleInfo.get("buyLink");
                ...
                Book bookItem = new Book(title, author, imageURL.toString(), link, description);
